...
├ .glass [ reply gambar ]
├ .sampah [ reply gambar ]
├ .trigger [ reply gambar ]
├ .greyscale [ reply gambar ]
├ .hijau [ reply gambar ]
├ .biru [ reply gambar ]
├ .comrade [ reply gambar ]
├ .jail [ reply gambar ]
├ .blurple2 [ reply gambar ]
├ .red [ reply gambar ]
├ .blurple [ reply gambar ]
├ .invert [ reply gambar ]
├ .invert_greyscale [ reply gambar ]
├ .sepia [ reply gambar ]
├ .pelangi [ reply gambar ]
├ .wasted [ reply gambar ]
├ .matrix [ teks ]
├ .googletxt [ teks ]
├ .spiderman [ teks ]
...
├ .linkgrup
├ .hidetag [ teks ]
├ .sticktag [ nama sticker ]
├ .totag [ reply media ]
│
├─❒ TOOLS
├ .sticker
├ .stickerwm [ nama|author ]
├ .takestick [ nama|author ]
...
├ .fitnahpc [ nomor|teks1|teks2 ]
├ .chat [ nomor|teks ]
├ .fdeface [ replyimg link|teks1|teks2 ]
├ .listgrup
├ .baileys [ reply message ]
├ .q [ reply message ]
├ .getcaption [ reply message ]
├ .pantun
├ .tospam [ reply audio/sticker/image|jumlah ]
├ .sharelock [ teks1|teks2 ]
└─────────────────❒`
gbutsan = [
...
└─────────────────❒`
sendButLocation(from, `${menu}`, "*_© Azril Maulana_*", {jpegThumbnail:ofrply,name:""}, [{buttonId:`command`,buttonText:{displayText:'SEWA BOT'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
break
case 'allmenu': 
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
stod = `${sender}`
       stst = await denz.getStatus(`${sender.split('@')[0]}@c.us`)
       nama = '🌹 ALL MENU 🌹'
       ownerJid = "6282147244748@s.whatsapp.net"
				stst = stst.status == 401 ? '' : stst.status
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
menunya = `╭─❒ 「 Bot Info 」 ❒
├ _Creator : @${dtod.split('@')[0]}_
...
🔖 ${prefix}ytmp4 [link yt] = Video`, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title:`SEARCH: ${args[0]}`,body:"🔖YOUTUBE SEARCH",mediaType:"2",thumbnail:pporigi,mediaUrl:`https://youtu.be/wy0sLoq6EmM`}}})
            } catch(e) {
